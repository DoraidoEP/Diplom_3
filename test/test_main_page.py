...
from data import TestData, DataUrl, TextAnswer
...
class TestMainPage:
    ...
    def test_constructor_button(self, driver):
        ...
        assert main_page.get_current_url() == DataUrl.STELLAR_BURGERS
    ...
    def test_order_list_button(self, driver):
        ...
        assert main_page.get_current_url() == DataUrl.ORDER_LIST_PAGE
    ...
    def test_make_order_auth_user(self, driver):
        ...
        login_page.login_account(TestData.user_data)
        main_page.ingredient_drag_and_drop()
